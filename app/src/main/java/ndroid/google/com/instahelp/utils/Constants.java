package ndroid.google.com.instahelp.utils;
...
public class Constants {
    ...
    public static final String ARG_FROM1 = "form1";
    public static final String ARG_FROM2 = "form2";
    public static final String ARG_FROM3 = "form3";
